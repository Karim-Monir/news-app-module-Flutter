...
class AppSearchLoadingState extends NewsAppStates {}

class AppGetSearchNewsSuccessState extends NewsAppStates {}

class AppGetSearchNewsErrorState extends NewsAppStates {
  final String error;
...
class AppModeState extends NewsAppStates {}